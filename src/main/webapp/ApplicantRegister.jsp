...
<head>
    <meta charset="UTF-8">
    <title>TalentForge | Applicant Registration</title>
...
<nav>
  ...
  <p > <a href="/"> <img src="/images/greennavlogo.png" width="180px" height="80" /></a></p>
    <ul class="nav-links">
      ...
      <li><a href="contactus"><i class="fa fa-phone"> &nbsp;CONTACT US</i></a></li>       <li><a href="ApplicantLogin"><i class='fas fa-user-tie'> &nbsp;APPLICANT LOGIN</i></a></li>
